...
**Papastamoulis P and Milienos FS (2024b)**. [*bayesCureRateModel: Bayesian Cure Rate Modeling for Time to Event Data in R*](https://arxiv.org/abs/2409.10221). Journal of Statistical Software (to appear). 
